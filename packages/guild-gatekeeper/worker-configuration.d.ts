/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: d30e6e0a010625265c1a22338a04467d)
// Runtime types generated with workerd@1.20260730.1 2026-08-04 allow_irrevocable_stub_storage,global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	...
	AI: Ai;
	GUILD_ID: "018f1f3e-7b5a-7d40-8f43-4fe1dc555a9a";
	GUILD_NAME: "Example Guild";
	GUILD_PURPOSE: "Coordinate people and agents around shared memory and governed work.";
	GUILD_ROOT_SPACE_NAME: "Guild";
	GUILD_LEVEL2_QUORUM: "1";
	GUILD_LEVEL3_QUORUM: "1";
	GUILD_RETENTION_DAYS: "2555";
	GUILD_ASK_MODEL: "@cf/meta/llama-3.1-8b-instruct-fast";
	GUILD_AI_GATEWAY_ID: "default";
	GUILD_WEBHOOK_CONNECTOR_ID: "018f1f3e-7b5a-7d40-8f43-4fe1dc555a9b";
	...
	AGENT_EXECUTION: Workflow<Parameters<import("./.wrangler/validate/src/index").AgentExecutionWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GUILD_ID" | "GUILD_NAME" | "GUILD_PURPOSE" | "GUILD_ROOT_SPACE_NAME" | "GUILD_LEVEL2_QUORUM" | "GUILD_LEVEL3_QUORUM" | "GUILD_RETENTION_DAYS" | "GUILD_ASK_MODEL" | "GUILD_AI_GATEWAY_ID" | "GUILD_WEBHOOK_CONNECTOR_ID" | "GUILD_WEBHOOK_CONNECTOR_NAME" | "GUILD_WEBHOOK_URL" | "GUILD_WEBHOOK_SIGNING_SECRET">> {}
}
