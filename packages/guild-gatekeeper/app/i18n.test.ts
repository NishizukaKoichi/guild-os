...
const DYNAMIC_TRANSLATION_FAMILIES = {
  ...
  "blueprint.accent.${}": ["blue", "green", "amber", "rose", "violet"],
  "blueprint.bundle.${}": ["observe", "participate", "coordinate", "administer"],
  "blueprint.decision.${}": ["custodian", "consent", "vote", "review", "editorial", "policy", "hybrid", "quorum_vote", "council", "agent_proposal_human_approval", "custom"],
  "blueprint.home.${}": ["ask", "remember", "start", "review", "members"],
  "blueprint.lifecycle.${}": ["simple", "planned", "ready"],
  "blueprint.theme.${}": ["system", "quiet", "warm", "formal", "playful"],
  "context.classification.${}": ["public", "internal", "confidential", "restricted"],
  "collective.authorityImpact.${}": ["role-addition", "role-retirement", "capability-addition", "capability-removal"],
  ...
  "operations.connections.kind.${}": [
    "https_webhook", "mcp", "oauth", "webhook", "api", "cloudflare_gatekeeper",
    "cloudflare_service", "email", "calendar", "file_storage", "git_repository",
    "external_api", "model_provider", "database", "storage",
  ],
